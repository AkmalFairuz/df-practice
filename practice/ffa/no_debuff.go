...
func initNoDebuffArena(log *slog.Logger) {
	...
	noDebuffArena.spawns = []helper.Location{
		{X: 46, Y: 76.1, Z: 44, Yaw: 135, Pitch: 0},
		{X: 48, Y: 76.1, Z: 44, Yaw: 135, Pitch: 0},
		{X: 46, Y: 76.1, Z: 46, Yaw: 135, Pitch: 0},
		{X: 48, Y: 76.1, Z: 46, Yaw: 135, Pitch: 0},
		{X: 50, Y: 76.1, Z: 44, Yaw: 135, Pitch: 0},
	}
